...
const currentYear2 = 2037;
const ageAfonso = 2037 - 1991;
const ageSarah = 2037 - 2018;
console.log(ageAfonso, ageSarah);
console.log(ageAfonso * 2, ageAfonso / 10, 2 ** 3);

const firstName2 = "Afonso";
...
console.log(currentYear2 - 1991 > currentYear2 - 2018);

//Operator Precedent

const currentYear = 2037;
const ageAfonso2 = 2037 - 1991;
const ageSarah2 = 2037 - 2018;
...
const avarageAge = (ageAfonso2 + ageSarah2) / 2;
console.log(ageAfonso2, ageSarah2);
...
const firstName3 = "Afonso";
const job3 = "teacher";
const birthYear3 = 2002;
const year3 = 2025;
...
const afonsoNew = `I'm ${firstName3}, a ${
    year3 - birthYear3
} years old ${job3}`;
console.log(afonso);
...
if (age5 >= 18) {
    ...
    const yearsLeft = 18 - age5;
    console.log(`Sarah is too young. Wait another ${yearsLeft} years :)`);
}

const birthYear5 = 2002;
...
const drink = age8 >= 18 ? "wine 🍷" : "water 💧";
console.log(drink);
...
console.log(`I like to drink ${age8 >= 18 ? "wine 🍷" : "water 💧"}`);
